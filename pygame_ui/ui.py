...
def dibujar_seleccion(pantalla, pico):
    ...
    pygame.draw.polygon(pantalla, (255, 255, 0, 100), puntos, 5)
...
def dibujar_pantalla_fin(pantalla, ganador):
    ...
    rect_ganador = sup_ganador.get_rect(
    ...
    rect_continuar = sup_continuar.get_rect(
        center=(ANCHO_VENTANA / 2, ALTO_VENTANA / 2 + 100)
    )
...
def dibujar_info_turno(pantalla, game, mensaje_info):
    ...
    if mensaje_info:
        ...
        pantalla.blit(superficie_info,
                      (ANCHO_VENTANA / 2, ALTO_VENTANA + MARGEN + 60))
    ...
    while ejecutando:
        ...
        for evento in pygame.event.get():
            ...
            if estado == "INICIO":
                ...
                pico_seleccionado = manejar_eventos_jugando(
